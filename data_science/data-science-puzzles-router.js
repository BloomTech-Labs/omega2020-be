...
// While there remains a 4th difficulty level named 'diabolical' in the _9x9_puzzles database, we decided to exclude that endpoint from this version of the app for consistency.

// router.get('/9x9/diabolical', (req, res) => {
// 	pool.query(
// 		"SELECT gridLength, row, col, sudoku, solution, level, id FROM _9x9_puzzles WHERE level='Diabolical' ORDER BY RANDOM() LIMIT 1", (q_err, q_res) => {
// 			if (q_err) {
// 				console.log('There was an error retrieving the sudoku puzzle from the server.');
// 				throw error;
// 			}
